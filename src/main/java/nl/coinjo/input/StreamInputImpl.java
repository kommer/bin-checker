...
public class StreamInputImpl implements StreamInput {
    ...
    private Logger createNewLogger(String dir, String reference) {
        ...
        Appender appender = RollingFileAppender.createAppender("/files/"+dir+"/"+reference+"/_current.csv", "/files/"+dir+"/"+reference+"/%d{yyyy-MM-dd-HH}.csv","false", "false", "false", "5", "true",
